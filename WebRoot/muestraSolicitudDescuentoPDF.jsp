<%@ page import="com.sicap.clientes.vo.ClienteVO"%><%@ page import="com.sicap.clientes.vo.SolicitudVO"%><%@ page import="com.sicap.clientes.helpers.GeneraContratoHelper"%><%@ page import="com.sicap.clientes.helpers.HTMLHelper"%><%@ page import="com.sicap.clientes.util.SolicitudUtil"%><%@ page import="com.sicap.clientes.util.ClientesConstants"%><%
    ...
    if ( cliente.solicitudes!=null && indiceSolicitud!=-1 ){
		...
		response.setHeader("Content-Disposition","attachment; filename=\"SolicitudDescuento.pdf\"");
		response.setHeader("cache-control", "no-cache");	
		GeneraContratoHelper contrato = new GeneraContratoHelper();
		contrato.doPdfSolicitudDescuento(response, cliente, idSolicitud);
		}
	}%>