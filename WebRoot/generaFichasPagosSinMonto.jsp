...
//GrupoVO   grupo   = null;
    ...
    try {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"FichasPagosSinMonto.pdf\"");
        response.setHeader("cache-control", "no-cache");
        GeneraFichasPagoSinMontoHelper doc = new GeneraFichasPagoSinMontoHelper(); 
