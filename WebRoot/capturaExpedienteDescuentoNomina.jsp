...
<script type="text/javascript">
	...
	function guardaExpedienteDescuentoNomina(){
		window.document.forma.command.value='guardaExpedienteDescuentoNomina';
...
<input type="hidden" name="command" value="guardaExpedienteDescuentoNomina">
<input type="hidden" name="idSolicitud" value="<%=idSolicitud%>">
<table border="0" width="100%">
	<tr>
  	<td align="center">
 <%=HTMLHelper.displayNotifications(notificaciones)%>
 <h3>Check-List<br>Expediente Descuento Nómina</h3>
...
<tr>
  <td></td>
  <td align="left">Comprobantes de Pago</td>
...
<tr>
  <td></td>
  <td align="left">Credencial de Empleo Vigente</td>
...
<tr>
 <%if( solicitud.desembolsado==ClientesConstants.DESEMBOLSADO ){ %>
  	<td></td>
  	<td align="center"><input disabled type="button" value="Enviar" onClick="guardaExpedienteDescuentoNomina()"></td>
 <%}else{ %>
 	<td></td>
  <td align="center"><input type="button" value="Enviar" onClick="guardaExpedienteDescuentoNomina()"></td>
 <%}%>
</tr>	
