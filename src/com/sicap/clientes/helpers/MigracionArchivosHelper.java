 ...
 * @author LDAVILA
 */
public class MigracionArchivosHelper {

    private static Logger myLogger = Logger.getLogger(MigracionArchivosHelper.class);

    public static void migraArchivos() throws Exception {
        ...
        try {
            ...
            String servidor = CatalogoHelper.getParametro("FTP_SERVER");
            String usuario = CatalogoHelper.getParametro("FTP_USER");
            String password = CatalogoHelper.getParametro("FTP_PASSWORD");
            String rutaLocal = CatalogoHelper.getParametro("MIGRACION_RUTA_LOCAL");
            ...
            String respuesta = "";
            String pasoArchivo = "";
            arrArchivosBO = ArchivoAsociadoDAO.getArchivosMigracion();
            int CantMigrados = 0;
                    ...
                    if (fLocal.exists()) {
                        if (clienteFtp.changeWorkingDirectory(rutaDestinoComp)) {
                            ...
                            if (cambioDirFTp) {
                                ...
                                if (files.length > 0) {
                                    clienteFtp.deleteFile(arrArchivosBO1.nombre);
                                }
            ...
            try {
                String Destinatarios = CatalogoHelper.getParametro("MAIL_CIERRE_RECIPIENT");
                Mail.enviaCorreo("Error Migracion", "Error en migracion : " + e, Destinatarios);
