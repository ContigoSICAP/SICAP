...
public class SaldoIBSVO implements Serializable{
    ...
    private int maxCuotasVencidas;
    private int maxDiasMora;
    ...
    private int numAuditor;
    private int porGarantia;
    private int numIntegrantesDesembolso;
    private int numIntegrantesCancelacion;
    private int numIntegrantesAdicionales;
    private double interesDevengados;
    private double ivaInteresDevengados;
    private int idEstado;
    private int fondeoGarantia;
    private Date fechaAsigGarantia;
    ...
    public double getTasaElegida() {
        return tasaElegida;
    }

    public void setTasaElegida(double tasaElegida) {
        this.tasaElegida = tasaElegida;
    }
    ...
    public SaldoIBSVO() {
        ...
        idEstado = 0;
        fondeoGarantia = 0;
        fechaAsigGarantia = null;
    }

    public SaldoIBSVO(int credito, String referencia, int idClienteSICAP, int idSolicitudSICAP, int idSucursal, Date fechaGeneracion, int numeroCuotas, int numeroCuotasTranscurridas, int plazo, int periodicidad, Date fechaDesembolso, Date fechaVencimiento,double montoCredito, double saldoTotalAlDia, double saldoCapital, double saldoInteres, double saldoInteresVigente, double saldoInteresVencido, double saldoIvaInteres, double saldoMora, double saldoIVAMora, double saldoMulta, double saldoIVAMulta, double capitalPagado, double interesNormalPagado, double ivaInteresNormalPagado, double moratorioPagado, double ivaMoraPagado, double multaPagada, double ivaMultaPagado, Date fechaSigAmortizacion, double capitalSigAmortizacion, double interesSigAmortizacion, double ivaSigAmortizacion, double tasaInteresSinIVA, double tasaMoraSinIVA, double tasaIVA, double saldoConInteresAlFinal, double capitalVencido, double interesVencido, double ivaInteresVencido, double totalVencido, int estatus, int idProducto, int diasMora, int diasTranscurridos, int cuotasVencidas, int numeroPagosRealizados, double montoTotalPagado, Date fechaUltimoPago, double saldoBucket, int maxCuotasVencidas, int maxDiasMora) {
    ...
    public SaldoIBSVO(int credito, String referencia, int idClienteSICAP, int idSolicitudSICAP, int idSucursal, Date fechaGeneracion, int numeroCuotas, int numeroCuotasTranscurridas, int plazo, int periodicidad, Date fechaDesembolso, Date fechaVencimiento,double montoCredito, double saldoTotalAlDia, double saldoCapital, double saldoInteres, double saldoInteresVigente, double saldoInteresVencido, double saldoIvaInteres, double saldoMora, double saldoIVAMora, double saldoMulta, double saldoIVAMulta, double capitalPagado, double interesNormalPagado, double ivaInteresNormalPagado, double moratorioPagado, double ivaMoraPagado, double multaPagada, double ivaMultaPagado, Date fechaSigAmortizacion, double capitalSigAmortizacion, double interesSigAmortizacion, double ivaSigAmortizacion, double tasaInteresSinIVA, double tasaMoraSinIVA, double tasaIVA, double saldoConInteresAlFinal, double capitalVencido, double interesVencido, double ivaInteresVencido, double totalVencido, int estatus, int idProducto, int diasMora, int diasTranscurridos, int cuotasVencidas, int numeroPagosRealizados, double montoTotalPagado, Date fechaUltimoPago, double saldoBucket, int maxCuotasVencidas, int maxDiasMora,int idEstado) {
        this.credito = credito;
        this.referencia = referencia;
        this.idClienteSICAP = idClienteSICAP;
        this.idSolicitudSICAP = idSolicitudSICAP;
    ...
    public SaldoIBSVO(int credito, String referencia, int idClienteSICAP, int idSolicitudSICAP, int idSucursal, Date fechaGeneracion, int numeroCuotas, int numeroCuotasTranscurridas, int plazo, int periodicidad, Date fechaDesembolso, Date fechaVencimiento,double montoCredito, double saldoTotalAlDia, double saldoCapital, double saldoInteres, double saldoInteresVigente, double saldoInteresVencido, double saldoIvaInteres, double saldoMora, double saldoIVAMora, double saldoMulta, double saldoIVAMulta, double capitalPagado, double interesNormalPagado, double ivaInteresNormalPagado, double moratorioPagado, double ivaMoraPagado, double multaPagada, double ivaMultaPagado, Date fechaSigAmortizacion, double capitalSigAmortizacion, double interesSigAmortizacion, double ivaSigAmortizacion, double tasaInteresSinIVA, double tasaMoraSinIVA, double tasaIVA, double saldoConInteresAlFinal, double capitalVencido, double interesVencido, double ivaInteresVencido, double totalVencido, int estatus, int idProducto, int diasMora, int diasTranscurridos, int cuotasVencidas, int numeroPagosRealizados, double montoTotalPagado, Date fechaUltimoPago, double saldoBucket, int maxCuotasVencidas, int maxDiasMora,int idEstado, int fondeoGarantia ,Date fechaAsigGarantia) {
        this.credito = credito;
        this.referencia = referencia;
        this.idClienteSICAP = idClienteSICAP;
        this.idSolicitudSICAP = idSolicitudSICAP;
        ...
        this.maxDiasMora = maxDiasMora;
        this.idEstado = idEstado;
        this.fondeoGarantia = fondeoGarantia;
        this.fechaAsigGarantia = fechaAsigGarantia;
    }

    public SaldoIBSVO(int credito, String referencia, int idClienteSICAP, int idSolicitudSICAP, Date fechaGeneracion, int plazo, double saldoTotalAlDia, double saldoCapital, double saldoInteres, double saldoInteresVigente, double saldoInteresVencido, double saldoIvaInteres, double capitalPagado, double interesNormalPagado, double ivaInteresNormalPagado, Date fechaSigAmortizacion, double capitalSigAmortizacion, double interesSigAmortizacion, double ivaSigAmortizacion, double saldoConInteresAlFinal, double capitalVencido, double interesVencido, double ivaInteresVencido, double totalVencido, int estatus, int diasMora, int diasTranscurridos, int cuotasVencidas, int numeroPagosRealizados, double montoTotalPagado, Date fechaUltimoPago, double saldoBucket, Date fechaDesembolso, int numeroCuotasTranscurridas, double montoDesembolsado, int idSucursal) {
        this.credito = credito;
        this.referencia = referencia;
        this.idClienteSICAP = idClienteSICAP;
        this.idSolicitudSICAP = idSolicitudSICAP;
    ...
    public SaldoIBSVO(int idClienteSICAP, int idSolicitudSICAP, double saldoConInteresAlFinal, double saldoMulta, double saldoIVAMulta, double multaPagada, double ivaMultaPagado, double totalVencido, int estatus, double saldoBucket) {
        this.idClienteSICAP = idClienteSICAP;
        this.idSolicitudSICAP = idSolicitudSICAP;
        this.saldoConInteresAlFinal = saldoConInteresAlFinal;
        this.saldoMulta = saldoMulta;
    ...
    public SaldoIBSVO(int credito, int idClienteSICAP, int idSolicitudSICAP, String nombreCliente, double montoCredito, double saldoConInteresAlFinal, int diasMora, String referencia, java.sql.Date fechaVencimiento) {
        this.credito = credito;
        this.idClienteSICAP = idClienteSICAP;
        this.idSolicitudSICAP = idSolicitudSICAP;
    ...
    public SaldoIBSVO(double capitalPagado, double interesNormalPagado, double ivaInteresNormalPagado, double multaPagada, double ivaMultaPagado, double montoTotalPagado) {
        this.capitalPagado = capitalPagado;
        this.interesNormalPagado = interesNormalPagado;
        this.ivaInteresNormalPagado = ivaInteresNormalPagado;
        this.multaPagada = multaPagada;
    ...
    public SaldoIBSVO(int numeroCuotasTranscurridas, int estatus) {
        this.numeroCuotasTranscurridas = numeroCuotasTranscurridas;
        this.estatus = estatus;
    }

    public SaldoIBSVO(int estatus, String nomEstatus) {
        this.estatus = estatus;
        this.nomEstatus = nomEstatus;
    }

    public SaldoIBSVO(int idClienteSICAP, int idSolicitudSICAP, Date fechaDesembolso) {
        this.idClienteSICAP = idClienteSICAP;
        this.idSolicitudSICAP = idSolicitudSICAP;
        this.fechaDesembolso = fechaDesembolso;
    }
    
    public SaldoIBSVO(int idClienteSICAP, int idSolicitudSICAP, String nombreCliente, int estatus) {
        this.idClienteSICAP = idClienteSICAP;
        this.idSolicitudSICAP = idSolicitudSICAP;
        this.nombreCliente = nombreCliente;
        this.estatus = estatus;
    ...
    public int getMaxDiasMora() {
        return maxDiasMora;
    }

    public void setMaxDiasMora(int maxDiasMora) {
        this.maxDiasMora = maxDiasMora;
    }
    ...
    public int getNumAuditor() {
        return numAuditor;
    }

    public void setNumAuditor(int numAuditor) {
        this.numAuditor = numAuditor;
    }

    public int getPorGarantia() {
        return porGarantia;
    }

    public void setPorGarantia(int porGarantia) {
        this.porGarantia = porGarantia;
    }

    public int getNumIntegrantesDesembolso() {
        return numIntegrantesDesembolso;
    }

    public void setNumIntegrantesDesembolso(int numIntegrantesDesembolso) {
        this.numIntegrantesDesembolso = numIntegrantesDesembolso;
    }

    public int getNumIntegrantesCancelacion() {
        return numIntegrantesCancelacion;
    }

    public void setNumIntegrantesCancelacion(int numIntegrantesCancelacion) {
        this.numIntegrantesCancelacion = numIntegrantesCancelacion;
    }

    public int getNumIntegrantesAdicionales() {
        return numIntegrantesAdicionales;
    }

    public void setNumIntegrantesAdicionales(int numIntegrantesAdicionales) {
        this.numIntegrantesAdicionales = numIntegrantesAdicionales;
    }

    public double getInteresDevengados() {
        return interesDevengados;
    }

    public void setInteresDevengados(double interesDevengados) {
        this.interesDevengados = interesDevengados;
    }

    public double getIvaInteresDevengados() {
        return ivaInteresDevengados;
    }

    public void setIvaInteresDevengados(double ivaInteresDevengados) {
        this.ivaInteresDevengados = ivaInteresDevengados;
    }
   ...
   public int getIdEstado() {
    ...
    public int getFondeoGarantia() {
        return fondeoGarantia;
    }

    public void setFondeoGarantia(int fondeoGarantia) {
        this.fondeoGarantia = fondeoGarantia;
    }

    public Date getFechaAsigGarantia() {
        return fechaAsigGarantia;
    }

    public void setFechaAsigGarantia(Date fechaAsigGarantia) {
        this.fechaAsigGarantia = fechaAsigGarantia;
    }
