...
public class DescongelaAhorroVO  implements Serializable{
...
// Se inicializa variable nueva para la insercion del monto de cuenta Congelada
	...
	public String toString(){
		...
		respuesta += "numEmpresa=["+numEmpresa+"],";
	...
	public void setBancoDesembolso(int valor_cuota) {
