...
//                        integrantes.calificacion = ClientesConstants.CALIFICACION_CIRCULO_NA;
                ...
                if (integrantes.segContratado == SeguroConstantes.CONTRATACION_SI) {
                    ...
                    integrantes.montoConSeguro = costoSeguroContratado + integrantes.monto;
                    integrantes.montoConSeguroTemp = integrantes.montoConSeguro;
                }
              
                // Calculamos el monto con seguro financiado Agosto 2017
                System.out.println("seguro: " + integrantes.costoSeguro);
                System.out.println("monto: " + integrantes.monto);
                System.out.println("montoConSeguro: " + integrantes.montoConSeguro);
