...
public class CommandAltaIncidenciaBuroInterno implements Command{
	
	private String siguiente;

	public CommandAltaIncidenciaBuroInterno(String siguiente) {
	...
	public String execute(HttpServletRequest request) throws CommandException {
		...
		try{
			...
			buroDAO.addIncidenciaBuroInterno(buroInterno, conn);
			...
			notificaciones[0] = new Notification(ClientesConstants.INFO_TYPE,"El usuario fue ingresado en Buro Interno");
			request.setAttribute("NOTIFICACIONES", notificaciones);
