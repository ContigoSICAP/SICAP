...
public class CommandGuardaExpedienteComunal implements Command{
	
	private String siguiente;


	public CommandGuardaExpedienteComunal(String siguiente) {
	...
	public String execute(HttpServletRequest request) throws CommandException {
		...
		try{
			...
			BitacoraUtil bitutil = new BitacoraUtil(cliente.idCliente, request.getRemoteUser(), "CommandGuardaExpedienteComunal");
