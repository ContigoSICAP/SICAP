...
boolean otraFinancieraP3 = false;
...
boolean mostrarCartaRenovacion = false;

boolean sucursalCartaRen = CatalogoHelper.sucursalCartaRenovacion(ciclo.saldo.getIdSucursal());

if (sucursalCartaRen && (ciclo.saldo.getNumeroCuotasTranscurridas() == 11
        || ciclo.saldo.getNumeroCuotasTranscurridas() == 13) && ciclo.saldo.getEstatus() == 1){
    mostrarCartaRenovacion = true;

}
System.out.println("Semanas transcurridas: "+ciclo.saldo.getNumeroCuotasTranscurridas() );if ( ciclo.saldo.getNumeroCuotasTranscurridas() != 11
        && ciclo.saldo.getNumeroCuotasTranscurridas() != 13){
    mostrarCartaRenovacion = false;
}

if ( ciclo.saldo.getEstatus() != 1){
    mostrarCartaRenovacion = false;
}
otraFinancieraP3 = CatalogoHelper.esSucursalPiloto3(grupo.sucursal);
    if(otraFinancieraP3){
        for (int i=0; i <ciclo.integrantes.length;i++){
				...
				<tr>
					...
					<td align="center">
						Rol
                                        ...
                                        <%}%>
                                        <%if(ciclo.tieneAsignadoCreditoAdicional){%>
                                            <td align="center">
                                                Monto Adicional
                                            </td>
                                        <%}%>
...
<%for ( int i=0 ; ciclo.integrantes!=null && i<ciclo.integrantes.length ; i++ ){ 
	String estilo = "";
            ...
            if(ciclo.tieneAsignadoCreditoAdicional && ciclo.integrantes[i].montoAdicional > 0){
                estilo = "creditoAdicional";
            }        
%>
				<tr class="<%=estilo%>" >
					<td align="center">
					...
					<%if ( ciclo.integrantes[i].calificacion == ClientesConstants.CALIFICACION_CIRCULO_BUENA || ciclo.integrantes[i].calificacion == 0 ){ %>
						<input type="hidden" name="calificacion<%=i%>" id="calificacion<%=i%>" value="<%=ciclo.integrantes[i].calificacion%>">
                                                ...
                                                <%}else if(ciclo.integrantes[i].aceptaRegular == ClientesConstants.AUTORIZACION_OTRA_FINANCIERA && otraFinancieraP3){%>
					...
					<td align="center">
						...
						<%=HTMLHelper.displayCombo(catRoles, ciclo.integrantes[i].rol)%>
                                        ...
                                        <%if(ciclo.tieneAsignadoCreditoAdicional){%>
                                            <td align="right">
                                                <%=HTMLHelper.formatoMonto( ciclo.integrantes[i].montoAdicional)%>
                                            </td>
                                        <%}%>
				</tr>
<%
            ...
            <td colspan="2" align="center">
                <table width="90%" border="2" cellpadding="0" bordercolor="#0040FF">
                    ...
                    <tr>
                        ...
                        <td align="center" id="td">
                        <%if(mostrarCartaRenovacion){ %>
                            <a href="#" onClick="muestraDocumento('CARTARENOVACION')">Carta Renovaci&oacute;n</a>
                        <%}%>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td colspan="2" align="center">
                <table width="60%" border="2" cellpadding="0">
                    ...
                    <%if(ciclo.tieneAsignadoCreditoAdicional && !setPlazoAdicionales.isEmpty()){%>
                    <%for(Integer plazoAd : setPlazoAdicionales ){%>
                    
                    <tr id="semana<%=plazoAd%>Ad" onClick="cambiarDisplay('semana<%=plazoAd%>Ad_link')"  style="cursor: pointer;">
                        <td colspan="5>"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adicional Sem <%=plazoAd%></i></td>
                    </tr>
                    <tr id="semana<%=plazoAd%>Ad_link" onClick="cambiarDisplay('semana<%=plazoAd%>Ad_link')">
                        <td align="center" id="td" colspan="2"><a href="#" onClick="muestraDocumento('ODPADICIONAL_<%=plazoAd%>')">Consulta orden de pago</a></td>
                        <td align="center" id="td" colspan="1"><a href="#" onClick="muestraDocumento('PAGGRUPALADICIONAL_<%=plazoAd%>')">Pagaré grupal adicional</a></td>
                        <td align="center" id="td" colspan="2"><a href="#" onClick="muestraDocumento('PAGINDADICIONAL_<%=plazoAd%>')">Consulta pagaré individual</a></td>
                        <td align="center" id="td" colspan="1"><a href="#" onClick="muestraDocumento('ADENDUMADICIONAL_<%=plazoAd%>')">Addendum</a></td>
                    </tr>
    ...
    if (idCiclo > 0){%>
        <tr>
            <td align="center" colspan="2">
                <a href="generaFichasGarantia.jsp?idOperacion=3&idCiclo=<%=idCiclo%>">Ficha pago en garantía</a>&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    <%}
}%>
        ...
        <tr>
            <td align="center" colspan="2">
                <%if(request.isUserInRole("CONFIRMACION_DESEMBOLSO_GRUPAL")||(request.isUserInRole("AUTORIZACION_EQUIPOS_VIP")&&bitacoraCicloDao.getUsuarioAsignado(ciclo.idGrupo, ciclo.idCiclo).equals(request.getRemoteUser()))){%>
                <br><input type="button" name="guardaCiclo" id="guardaCiclo" value="Guarda Ciclo" onClick="guardaCicloGrupal(<%=numIntegrantes+1%>)">
                <%}%>
                <%if(fldSeguro == null && ciclo.idCiclo > 0 && campSeguro.equals("si")){%>
                ...
                <%} else if(ciclo.idCiclo > 0 && opcion > 0 && !ciclo.tieneAsignadoCreditoAdicional){%>
                ...
                <input type="hidden" name="tipoArchivo" value="fileDocumentacion"/>
                <input type="hidden" name="conSeguro" value="0"/>
                <input type="hidden" name="semanaAdicional" value="<%=ciclo.aceptaAdicional%>"/>
                <%}%>
                <%if (ciclo.estatus == 7 || ciclo.estatus == 8 || ciclo.estatus == 9 || ciclo.estatus == 6 || ciclo.estatus == 9 || ciclo.estatus == 10 || ciclo.estatus == 4 || ciclo.estatus == 5) {%>
                <input type="button" id="boton" value="Ficha de Pago sin Monto" onClick="location.href='generaFichasPagosSinMonto.jsp?idOperacion=3&idCiclo=<%=idCiclo%>'">
        ...
        <%if( isDesembolsadoFlag && ciclo.estatus!=2 && request.isUserInRole("CONFIRMACION_DESEMBOLSO_GRUPAL")){ %>
        <tr>
            <td align="center" colspan="2">
                <br><input type="button" name="guardaDatosExtra" id="guardaDatosExtra" value="Guarda otros datos" onClick="guardaOtrosDatos()" >			
            </td>
        </tr>
	<%}%>	
	<tr>
            <td align="center" colspan="2">
                <%if ( ciclo.tablaAmortizacion!=null && ciclo.tablaAmortizacion.length>0 && !isDesembolsadoFlag && desembolsoOk.equals("OK") && (request.isUserInRole("CONFIRMACION_DESEMBOLSO_GRUPAL")||(request.isUserInRole("AUTORIZACION_EQUIPOS_VIP")&&bitacoraCicloDao.getUsuarioAsignado(ciclo.idGrupo, ciclo.idCiclo).equals(request.getRemoteUser()))) && ((fldSeguro != null && campSeguro.equals("si")) || (fldSeguro == null && !campSeguro.equals("si")))){%>
                <br><input type="button" id="btn_desembolsar" value="Desembolsar" onClick="desembolsaCicloGrupal(<%=numIntegrantes+1%>)">
                <input type="button" id="btn_desembolso_prog" value="Desembolso Programado" onClick="desembolsaCicloGrupalProg()">
                <%}else{
                    //ESTA LINEA SIRVE PARA RESTRINGIR LA DISPERSION SI NO SE TIENE LOS DOCUMENTOS LEGALES Y OPERATIVOS
                    //if( ciclo.desembolsado == ClientesConstants.CICLO_DESEMBOLSADO && ciclo.estatus!=2 && isConfirmadorDesembolso && fldDocums != null){
                    if( ciclo.desembolsado == ClientesConstants.CICLO_DESEMBOLSADO && ciclo.estatus==10 && (isConfirmadorDesembolso||(request.isUserInRole("AUTORIZACION_EQUIPOS_VIP")&&bitacoraCicloDao.getUsuarioAsignado(ciclo.idGrupo, ciclo.idCiclo).equals(request.getRemoteUser())))){%>
                    <br>Fecha de Dispersi&oacute;n
                        <%if(request.isUserInRole("FECHA_DISPERSION")||(request.isUserInRole("AUTORIZACION_EQUIPOS_VIP")&&bitacoraCicloDao.getUsuarioAsignado(ciclo.idGrupo, ciclo.idCiclo).equals(request.getRemoteUser()))){%>
                    <br><input type="text" name="fechaConfirmacion" id="Fecha1" size="10%" maxlength="10" value="<%=HTMLHelper.displayField(new java.util.Date())%>">
                        <%}else{%>
                        <br><input type="text" name="fechaConfirmacion" id="Fecha1" size="10%" maxlength="10" value="<%=HTMLHelper.displayField(new java.util.Date())%>" disabled="">
                        <%}%>
                    ...
                    <%} else if(request.isUserInRole("CONFIRMACION_DESEMBOLSO_GRUPAL")||(request.isUserInRole("AUTORIZACION_EQUIPOS_VIP")&&bitacoraCicloDao.getUsuarioAsignado(ciclo.idGrupo, ciclo.idCiclo).equals(request.getRemoteUser()))) {%>
                    <br><input disabled type="button" value="Desembolsar" onClick="desembolsaCicloGrupal(<%=numIntegrantes+1%>)">
                    <input disabled type="button" value="Desembolso Programado" onClick="desembolsaCicloGrupalProg(<%=numIntegrantes+1%>)">
                    <%}
                }%>
		</td>
	</tr>
