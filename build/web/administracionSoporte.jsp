...
<script>
	function migracionSemanal(){
            ...
            if(confirm("¿Realmente desea realizar la migración de historicos a BSC?")){
...
<div><table border="0" width="100%" cellspacing="0" align="center" height="10%">
        <%--
        <tr>
            <td width="100%" align="center" colspan="2" id="td"><br><a href="#" onClick="eliminaCiclo()">Eliminación ciclo</a><br><br></td>
	</tr>
        --%>
        <tr>
            <td width="100%" align="center" colspan="2" id="td"><br><a href="#" onClick="migracionSemanal()">Migración Semanal</a><br><br></td>
	</tr>
